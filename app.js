...
// var firstName = prompt("enter first name: "); //Sajeel
// var lastName = prompt("enter last name: "); //Ahmed
// var fullName = (firstName + " " + lastName);  
// document.write(" Hello ! " + fullName + "<br>" + " Have a nice day. ");

// Question 02

// var favPhone = prompt("Favourite phone: "); //Samsung Galaxy Note 9
...
// var b=+prompt("Also Enter The Length Of the table to be generated?");
